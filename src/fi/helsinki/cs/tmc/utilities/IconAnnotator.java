    ...
    public Image annotateIcon(Project p, Image orig, boolean openedNode) {
        ...
        try {
            ...
            switch (status.getStatus()) {
                case AllTestsPassed:
                    image = ImageIO.read(syscl.getResource("fi/helsinki/cs/tmc/smiley.gif"));
                    tooltip = "Exercise was sent and all tests passed.";
                    break;

                case SendAndSomeTestsFailed:
                    image = ImageIO.read(syscl.getResource("fi/helsinki/cs/tmc/serious.gif"));
                ...
                case NotSend:
                default:
                    image = ImageIO.read(syscl.getResource("fi/helsinki/cs/tmc/frownie.gif"));
