...
public class ProjectActionEventSource implements ProjectActionCaptor.Listener {
    ...
    //TODO: also capture the TMC actions.
    //Or make them go through an ActionProvider.
    ...
    public void actionInvoked(Project project, String command) {
        ...
        if (ex != null) {
            String data = command;
            LoggableEvent event = new LoggableEvent(ex, "project_action", data.getBytes(Charset.forName("UTF-8")));
