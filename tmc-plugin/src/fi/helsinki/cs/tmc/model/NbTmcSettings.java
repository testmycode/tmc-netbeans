...
public class NbTmcSettings implements TmcSettings {
    ...
    private static final String PREF_CHECK_FOR_UPDATES_IN_BACKGROUND =
    ...
    /*package*/ NbTmcSettings(
            PersistableSettings settings, Tailoring tailoring, TmcEventBus eventBus) {
